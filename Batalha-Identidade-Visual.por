programa
{
	...
	funcao inicio ()
	{
		...
		enquanto (go==0)
		{
			...
			matk=0
			mdef=0
			//Inserção dos atributos do montro
			enquanto (enter != "sim")
			{
				limpa()
				escreva("Insira a vida do oponente: ")
				leia(mh)
				mh=mh*10
				escreva("---------------------------------\nInsira o ataque do oponente: ")
				leia(matk)
				escreva("---------------------------------\nInsira a defesa do oponente: ")
				leia(mdef)
				limpa()
				//Confirmação dos atributos
				escreva("Confirme os atributos:\n\n---------------------\nVida total = ",mh,"\n---------------------\nAtaque =      ",matk,"\n---------------------\nDefesa =      ",mdef,"\n---------------------\n\nSe todos estiverem corretos digite 'sim' para começar o jogo: ")
				leia(enter)
			}
